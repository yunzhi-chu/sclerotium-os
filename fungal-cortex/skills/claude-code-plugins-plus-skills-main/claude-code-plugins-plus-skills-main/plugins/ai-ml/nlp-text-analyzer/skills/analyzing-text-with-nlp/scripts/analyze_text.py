...
class Analyzer:
    ...
    def generate_report(self) -> str:
        ...
        report = []
        report.append("\n" + "=" * 60)
        report.append("ANALYSIS REPORT - nlp-text-analyzer")
        report.append("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to perform text analysis tasks (sentiment, keywords, topics) based on user input and specified parameters."
    )
