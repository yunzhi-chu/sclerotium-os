#!/usr/bin/env python3
"""
database-diff-tool - Generator Script
Generates database migration scripts based on the schema differences.
...
Generated by database-diff-tool
...
"""
    ...
    def generate_json(self, data: Dict) -> Path:
        ...
        output_data = {
            "generated_by": "database-diff-tool",
...
def main():
    parser = argparse.ArgumentParser(
        description="Generates database migration scripts based on the schema differences."
    )
    parser.add_argument("--type", choices=["markdown", "json", "script"], default="markdown")
    parser.add_argument("--output", "-o", default="./output", help="Output directory")
    parser.add_argument("--config", "-c", help="Configuration file")
    parser.add_argument("--title", default="database-diff-tool Output")
