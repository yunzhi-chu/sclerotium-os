...
class Analyzer:
    ...
    def generate_report(self) -> str:
        ...
        report = []
        report.append("\n" + "=" * 60)
        report.append("ANALYSIS REPORT - security-headers-analyzer")
        report.append("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to perform the security header analysis using libraries like requests and beautifulsoup4."
    )
