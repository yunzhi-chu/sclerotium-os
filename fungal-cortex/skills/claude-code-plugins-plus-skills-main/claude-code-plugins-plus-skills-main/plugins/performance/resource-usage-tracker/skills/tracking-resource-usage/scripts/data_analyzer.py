...
class Analyzer:
    ...
    def generate_report(self) -> str:
        ...
        report = []
        report.append("\n" + "=" * 60)
        report.append("ANALYSIS REPORT - resource-usage-tracker")
        report.append("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to analyze the collected resource usage data and identify performance bottlenecks or anomalies."
    )
