...
Creates a comment on a GitHub pull request, highlighting detected performance regressions and linking to the generated report.
...
def main():
    parser = argparse.ArgumentParser(
        description="Creates a comment on a GitHub pull request, highlighting detected performance regressions and linking to the generated report."
    )
