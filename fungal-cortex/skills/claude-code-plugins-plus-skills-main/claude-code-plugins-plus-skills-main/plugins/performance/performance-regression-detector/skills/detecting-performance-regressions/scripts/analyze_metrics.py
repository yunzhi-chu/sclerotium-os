...
class Analyzer:
    ...
    def generate_report(self) -> str:
        ...
        report = []
        report.append("\n" + "=" * 60)
        report.append("ANALYSIS REPORT - performance-regression-detector")
        report.append("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Analyzes performance metrics from CI/CD pipeline output, comparing against baselines and thresholds. Returns a JSON object indicating regressions."
    )
