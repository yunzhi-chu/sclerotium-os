# Industry Examples & Question Templates
...
### Sliding Scale Questions (1-10)

- How satisfied are you with your current [area]?
- How confident are you in your ability to [action]?
- How important is [outcome] to you right now?
- How often do you [behavior]?
- How stressful is [situation] for you?
...
- I need to convince others first (influencer, not decider)
...
## Dynamic Results Copy Templates

### Low Score (0-40%)

**Tone:** Encouraging, not judgmental. Focus on potential.
...
1. [Simple action they can take today]
...
**Tone:** Acknowledging progress, highlighting opportunity.
...
Your opportunity: [Category they scored lowest]

Key insight: [Specific observation]

Your recommended next steps:
1. [Action to optimize their strength]
2. [Action to address their weakness]
3. [Mid-tier offer - book + call, workshop, etc.]

You're in a great position to accelerate your progress.
```

### High Score (71-100%)

**Tone:** Celebratory, but with advanced opportunities.
...
- Working with specialists who understand advanced challenges

Your recommended next step:
[Premium offer - direct consultation, advanced program]

Our team works with a select number of high-performers like yourself.
```
...
**Subject:** Your [Scorecard Name] Results: [X]%
...
- [Opportunity category]: [Score]% ←

[1-2 sentence insight]

📄 Your full personalized report is attached.
...
It'll only take another [X] minutes, and you'll get:
- Your personalized score across [X] areas
