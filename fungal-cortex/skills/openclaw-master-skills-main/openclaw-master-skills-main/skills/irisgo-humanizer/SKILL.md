---
name: humanizer
description: Remove AI writing patterns based on Wikipedia's "Signs of AI writing" research. 24 pattern detection and rewriting rules for making AI-generated text sound natural.
version: 1.0.0
author: IrisGo.AI
license: MIT
metadata: {"tags":["writing","editing","ai-detection","humanize"],"repository":"https://github.com/IrisGoLab/humanizer-skill"}
allowed-tools:
  - Read
  - Write
  - Edit
