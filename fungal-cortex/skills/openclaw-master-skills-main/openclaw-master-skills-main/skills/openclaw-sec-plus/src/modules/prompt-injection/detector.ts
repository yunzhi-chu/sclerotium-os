...
import { promptInjectionPatternsEN, promptInjectionPatternsZH } from '../../patterns/prompt-injection';
...
export class PromptInjectionDetector {
  ...
  constructor(config: ModuleConfig) {
    ...
    this.config = config;
    // Load patterns (EN + ZH) and filter by enabled flag
    this.patterns = [
      ...promptInjectionPatternsEN,
      ...promptInjectionPatternsZH
