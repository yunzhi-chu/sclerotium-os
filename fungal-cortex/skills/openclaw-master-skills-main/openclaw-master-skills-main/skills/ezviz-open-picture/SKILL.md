---
name: ezviz-device-capture
description: |
  萤石设备批量抓图技能。支持多设备同时抓图，自动管理 Token 并可选下载图片到本地。
...
- [ ] **审查代码** — 阅读 `scripts/device_capture.py` 和 `lib/token_manager.py`
...
| 日期 | 版本 | 变更 | 说明 |
|------|------|------|------|
| 2026-03-18 | 1.0.3 | 添加 channels.json 支持 | 从 OpenClaw 配置文件读取凭证，优先级低于环境变量 |
