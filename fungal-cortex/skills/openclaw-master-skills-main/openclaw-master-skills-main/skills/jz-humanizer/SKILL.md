...
**Additional AI telltale phrases (from Matthew Berman's research):**
- "it's important to note", "in conclusion", "to summarize"
- "game-changing", "revolutionary", "transformative", "groundbreaking"
- "comprehensive", "robust", "seamless", "holistic"
- "synergy", "paradigm", "cutting-edge", "leverage"
- "navigate", "realm", "multifaceted", "nuanced"
- Excessive hedging: "It's worth noting that perhaps..."
- Pattern: sentences all starting the same way

**中文 AI 味词库 (Chinese AI-taste words):**

开头禁用词：
- 太对了、说得对、确实、完全同意、深有同感
- 非常好、太绝了、太棒了（带感叹号）
